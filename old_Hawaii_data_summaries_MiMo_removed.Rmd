...
This is the same as the R script 'old_Hawaii_data_summaries', but with Mililii and Moku viruses removed (just because they aren't int he 2025 data - because they are not int he database. I think also this is fine as these aren't viruses known to be able to cause pathology in bees/assigned 'bee viruses' in amy studies)
...
#ggsave("31Mar_bee_virus_pies_2012_no_MiMo.pdf", plot = pie_2012, width = 7, height = 4)
...
#ggsave("31Mar_bee_virus_pies_2016_no_MiMo.pdf", plot = pie_2016, width = 7, height = 4)
